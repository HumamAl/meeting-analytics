    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 py-8 md:px-6 space-y-8">
        ...
        <CtaCloser
          ...
          subtext="I've already thought through the cascade architecture, the merge strategy, and the fixture harness. Let's walk through how they apply to your specific codebase."
